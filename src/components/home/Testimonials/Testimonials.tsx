...
const Testimonials = () => {
  return (
    <>
      <section className="py-[30px] lg:py-[120px] bg-[#F7F7F7]">
        <div className="w-[88%] mx-auto max-w-[1300px]">
          <h2 className=" text-[32px] md:text-[40px] leading-[40px] md:leading-[1.3] text-center font-bold text-[#020a19] pb-0 md:pb-[20px]">
            ...
            <Carousel className="w-full">
              <CarouselContent className="-ml-1">
                <CarouselItem className="pl-1  basis-full">
                  <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-12 bg-white rounded-[18px] overflow-hidden">
                    <div className="col-span-4 md:col-span-2 lg:col-span-4">
                      <Image src={UserOne} alt="dalibor-kruljac" className="h-full object-cover"/>
                    </div>
                    <div className="col-span-4 md:col-span-4 lg:col-span-8 self-center md:py-[47px]">
                      ...
                      <div className="px-[20px] py-[20px] md:pl-[60px] md:pr-[55px] md:pt-[26px]  md:pb-[25px]">
                        <p className="relative text-center md:text-left text-sm leading-[11px] sm:text-xl sm:leading-[33px] pb-[5px] sm:pb-0 text-[#020a19] font-bold 
                      before:content-[''] before:absolute before:bg-[#F7F7F7] before:w-full before:-top-5 before:left-0 before:right-0 before:h-[1px]">Justin Modrak</p>
                        <small className="text-center md:text-left w-full text-xs leading-[16px] sm:text-sm sm:leading-[18px] text-[#020a19] font-normal opacity-70 block">Technology Coordinator</small>
                        <small className="text-center md:text-left w-full text-xs leading-[16px] sm:text-sm sm:leading-[18px] text-[#020a19] font-normal opacity-70 block">East Troy Community School District</small>
                      </div>
                    </div>
                  </div>
                </CarouselItem>
                ...
                <CarouselItem className="pl-1  basis-full">
                  <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-12 bg-white rounded-[18px] overflow-hidden">
                    <div className="col-span-4 md:col-span-2 lg:col-span-4">
                      <Image src={UserTwo} alt="justin-modrak" className="h-full object-cover"/>
                    </div>
                    <div className="col-span-4 md:col-span-4 lg:col-span-8 self-center md:py-[47px]">
                      ...
                      <div className="px-[20px] py-[20px] md:pl-[60px] md:pr-[55px] md:pt-[26px]  md:pb-[25px]">
                        <p className="relative text-center md:text-left text-sm leading-[11px] sm:text-xl sm:leading-[33px] pb-[5px] sm:pb-0 text-[#020a19] font-bold 
                      before:content-[''] before:absolute before:bg-[#F7F7F7] before:w-full before:-top-5 before:left-0 before:right-0 before:h-[1px]">Dalibor Kruljac</p>
                        <small className="text-center md:text-left w-full text-xs leading-[16px] sm:text-sm sm:leading-[18px] text-[#020a19] font-normal opacity-70 block">KAMELEYA LTD</small>
                      </div>
                    </div>
                  </div>
                </CarouselItem>
                ...
                <CarouselItem className="pl-1  basis-full">
                  <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-12 bg-white rounded-[18px] overflow-hidden">
                    <div className="col-span-4 md:col-span-2 lg:col-span-4">
                      <Image src={UserThree} alt="chris-robinson" className="h-full object-cover"/>
                    </div>
                    <div className="col-span-4 md:col-span-4 lg:col-span-8 self-center md:py-[47px]">
                      ...
                      <div className="px-[20px] py-[20px] md:pl-[60px] md:pr-[55px] md:pt-[26px]  md:pb-[25px]">
                        <p className="relative text-center md:text-left text-sm leading-[11px] sm:text-xl sm:leading-[33px] pb-[5px] sm:pb-0 text-[#020a19] font-bold 
                      before:content-[''] before:absolute before:bg-[#F7F7F7] before:w-full before:-top-5 before:left-0 before:right-0 before:h-[1px]">Chris Robinson</p>
                        <small className="text-center md:text-left w-full text-xs leading-[16px] sm:text-sm sm:leading-[18px] text-[#020a19] font-normal opacity-70 block">Executive Account Manager, NCS</small>
                      </div>
                    </div>
                  </div>
                </CarouselItem>
          ...
          >
            <CarouselContent className="-ml-1">
              <CarouselItem className="basis-1/2 md:basis-1/3 lg:basis-auto">
                <div className="p-1">
